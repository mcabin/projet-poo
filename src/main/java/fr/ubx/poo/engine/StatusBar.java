...
public class StatusBar {
    ...
    public void update(Game game) {
        updateLevel(game.getCurrLevel());
        liveValue.setText(String.valueOf(game.getPlayer().getLives()));
        rangeValue.setText(String.valueOf(game.getPlayer().getRangeValue()));
        bombsValue.setText(String.valueOf(game.getPlayer().getBombValue()));
